...
## afterwards you only need to run
	ciliumctl completion bash > $(brew --prefix)/etc/bash_completion.d/cilium


# Installing bash completion on Linux
## Load the cilium completion code for bash into the current shell
	source <(ciliumctl completion bash)
## Write bash completion code to a file and source if from .bash_profile
	ciliumctl completion bash > ~/.cilium/completion.bash.inc
	printf "
...
## Load the cilium completion code for zsh into the current shell
	source <(ciliumctl completion zsh)
## Write zsh completion code to a file and source if from .zshrc
	ciliumctl completion zsh > ~/.cilium/completion.zsh.inc
	printf "
	  # Cilium shell completion
...
## Write fish completion code to fish specific location
	ciliumctl completion fish > ~/.config/fish/completions/cilium.fish
`
