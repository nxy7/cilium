...
func copyCiliumInfoCommands(cmdDir string, k8sPods []string) []string {
	...
	ciliumCommands := []string{
		fmt.Sprintf("ciliumctl debuginfo --output=markdown,json -f --output-directory=%s", cmdDir),
		"ciliumctl metrics list",
		"ciliumctl fqdn cache list",
		"ciliumctl config -a",
		"ciliumctl encrypt status",
		"ciliumctl endpoint list",
		"ciliumctl bpf auth list",
		"ciliumctl bpf bandwidth list",
		"ciliumctl bpf config list",
		"ciliumctl bpf tunnel list",
		"ciliumctl bpf lb list",
		"ciliumctl bpf lb list --revnat",
		"ciliumctl bpf lb list --frontends",
		"ciliumctl bpf lb list --backends",
		"ciliumctl bpf lb list --source-ranges",
		"ciliumctl bpf lb maglev list",
		"ciliumctl bpf egress list",
		"ciliumctl bpf vtep list",
		"ciliumctl bpf endpoint list",
		"ciliumctl bpf ct list global",
		"ciliumctl bpf nat list",
		"ciliumctl bpf ipmasq list",
		"ciliumctl bpf ipcache list",
		"ciliumctl bpf policy get --all --numeric",
		"ciliumctl bpf sha list",
		"ciliumctl bpf fs show",
		"ciliumctl bpf recorder list",
		"ciliumctl ip list -n -o json",
		"ciliumctl map list --verbose",
		"ciliumctl map events cilium_ipcache -o json",
		"ciliumctl map events cilium_tunnel_map -o json",
		"ciliumctl map events cilium_lb4_services_v2 -o json",
		"ciliumctl map events cilium_lb4_backends_v2 -o json",
		"ciliumctl map events cilium_lb4_backends_v3 -o json",
		"ciliumctl map events cilium_lb6_services_v2 -o json",
		"ciliumctl map events cilium_lb6_backends_v2 -o json",
		"ciliumctl map events cilium_lb6_backends_v3 -o json",
		"ciliumctl map events cilium_lxc -o json",
		"ciliumctl service list",
		"ciliumctl service list -o json",
		"ciliumctl recorder list",
		"ciliumctl status --verbose",
		"ciliumctl identity list",
		"ciliumctl-health status --verbose",
		"ciliumctl-health status -o json",
		"ciliumctl policy get",
		"ciliumctl policy selectors -o json",
		"ciliumctl node list",
		"ciliumctl node list -o json",
		"ciliumctl bpf nodeid list",
		"ciliumctl lrp list",
		"ciliumctl cgroups list -o json",
		"ciliumctl statedb dump",
		"ciliumctl bgp peers",
		"ciliumctl bgp routes available ipv4 unicast",
		"ciliumctl bgp routes available ipv6 unicast",
	}
	var commands []string
