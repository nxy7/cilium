...
* Monitoring components such as ``ciliumctl monitor`` will experience a brief
...
.. code-block:: shell-session
      ...
      $ kubectl exec -n kube-system cilium-pre-flight-check-1234 -- ciliumctl preflight migrate-identity
...
.. code-block:: shell-session
      ...
      $ kubectl exec -n kube-system cilium-1234 -- ciliumctl endpoint list # existing etcd-backed endpoints
